...
namespace WinFormsDopravniPodnik.model
{
    ...
    { 
        ...
        {
            WinFormsDopravniPodnik.CustomerService1.CusomerServiceClient sc = new WinFormsDopravniPodnik.CustomerService1.CusomerServiceClient();
        ...
        private static Customer CastTo(CustomerService1.Customer customer)
        {
